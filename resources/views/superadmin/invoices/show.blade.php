...
<div class="container-fluid">
    <div class="mb-4 d-flex justify-content-center">
        <a href="{{ route('superadmin.invoices.print', $invoice) }}" class="btn btn-primary mx-2" target="_blank">
            <i class="fas fa-print"></i> Print Invoice
        </a>
        <a href="{{ route('superadmin.invoices.download', $invoice) }}" class="btn btn-success mx-2" target="_blank">
            <i class="fas fa-file-pdf"></i> Download PDF
        </a>
        @if($invoice->status !== 'paid')
        <a href="{{ route('superadmin.invoices.payPage', $invoice) }}" class="btn btn-warning mx-2">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <dl class="row">
                ...
                <dt class="col-sm-3">Practitioner</dt>
                <dd class="col-sm-9">{{ $invoice->practitioner->name ?? '-' }}</dd>
            ...
            <a href="{{ route('superadmin.invoices.index') }}" class="btn btn-secondary">Back to List</a>
        </div>
    </div>
</div>
@endsection 