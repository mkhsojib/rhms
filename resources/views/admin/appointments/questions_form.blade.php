    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.appointments.questions.update', $appointment) }}" method="POST">
                        @csrf
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('admin.appointments.show', $appointment) }}" class="btn btn-secondary ml-2">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
